      ...
      <div className=" flex flex-col gap-4">
        ...
        <div className=" flex flex-col gap-2 p-4 md:p-8 lg:p-24">
          ...
          <p className=" text-white font-d-din-regular text-[14px] md:text-[20px] sm:text-[16px] lg:text-[25px] text-left">
            Are you a passionate gamer seeking rewards for your gaming prowess?
            Look no further, because GTM Arcade is your home for immersive
            gaming experiences and exciting rewards!
          </p>
        </div>
        ...
        <div className=" flex flex-col gap-2 p-4 md:p-8 lg:p-24">
          ...
          <p className=" text-white font-d-din-regular text-[14px] md:text-[20px] sm:text-[16px] lg:text-[25px] text-left">
            Join a lobby of your choice and face off against other players. The
            winner takes home a whopping 90% of the stakes, while the remaining
            10% is contributed to the project vault. This fund will be utilized
            to drive the project forward, ensuring continuous innovation and
            improvement
          </p>
        </div>
        {/* ------------------------------------------------------------------------------------- */}
