...
const TestimonialCard :React.FC<TestimonialCardParams> = ({image , heading , content}) => {
  return (
    <div className="flex flex-col gap-4 w-[330px] items-center justify-center ">
      ...
      <p className="text-white text-[24px] font-d-din-regular mx-auto text-center w-[300px]">{content}</p>
    </div>
  )
